# ruft alle 5 Stunden USD-EUR Wechselkurs auf
# ruft alle 2 min. kryptoApi Preise auf
# Gibt geordnete Ausgabe in token_price.json aus.

# Ausständig:
# Integration bzw. speichern auf core Webserver (JSON)
# API Integration zum abrufen
