...
def save_to_json(data, filename="token_price.json"):
    ...
    Die Datei wird an https://xenexai.com/connect/currency_connect.php gesendet,
    ...
    try:
        ...
        # Anschließender Upload der Datei auf den externen Server
...
def update_coin_history(source, coin_id, price_usd, price_eur, timestamp, folder="coin_history"):
    ...
    try:
        ...
        # Falls die Datei existiert, lade die vorhandenen Einträge, ansonsten starte mit einer leeren Liste.
        ...
        print(f"Fehler beim Aktualisieren der History für {source} {coin_id}: {e}")
...
def update_coin_data():
    ...
    # Aktualisiere für jeden Coin in jeder Quelle die History-Dateien
