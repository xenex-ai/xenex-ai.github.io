...
def build_status_table(total, successful, latest):
    """
...
def generator_thread():
    ...
    """
    while running:
        # Falls die Queue voll ist, kurz warten
...
def status_updater():
    ...
    with Live(Panel("Starte Generator ...", title="Status", border_style="green"), refresh_per_second=4, console=console) as live:
        while running:
            ...
            live.update(Panel(build_status_table(total, successful, latest), title="Status", border_style="green"))
            time.sleep(0.2)
...
/____/   /__(  )__\    \____/   
    ...
    # Starte Worker-Threads mittels ThreadPoolExecutor (z.B. 100 parallele Threads)
    worker_count = 100
