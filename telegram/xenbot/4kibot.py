...
async def add_points(user_id, username, points):
    ...
    - Wenn ein Event aktiv ist, werden die Punkte in EVENT_POINTS_FILE gespeichert.
    - Sonst in POINTS_FILE.
    """
    global event_active
...
async def auto_question(context: ContextTypes.DEFAULT_TYPE):
    ...
    - Gleichzeitig wird ein Job geplant, der das Event nach 30 Minuten beendet.
    """
    global event_active
